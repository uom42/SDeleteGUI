...
namespace SDeleteGUI.Core.SDelete
{
	internal class ProgressInfoEventArgs : EventArgs
	{
		...
		internal ProgressInfoEventArgs(string raw) : base()
		{
		...
		public override string ToString() => Localization.Strings.L_PROGRESS.e_Format(PassCount, ProgressPercent, SpeedValue, SpeedUnits);
	}
