...
namespace SDeleteGUI
{
	internal partial class frmMain : Form
	{
		...
		private async Task CheckShellRegistration(bool isFirstRun)
		{
			...
			using var tskCheckRegistration = new Task<bool>(()
			...
			DialogResult dr = "Register in shell context menu for folders clean up?".e_MsgboxWithCheckboxAsk(C_DIALOGID_DO_NOT_ASK_SHELL_CONTEXT_MENU_REGISTRATION);
